...
ActiveRecord::Schema[7.2].define(version: 2024_11_14_092858) do
  ...
  create_table "grid_cells", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["content_id"], name: "index_grid_cells_on_content_id"
    t.index ["server_id"], name: "index_grid_cells_on_server_id"
    t.index ["treasure_id"], name: "index_grid_cells_on_treasure_id"
  end
  ...
  create_table "leaderboards", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["server_id"], name: "index_leaderboards_on_server_id"
  end
  ...
  create_table "scores", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["server_id"], name: "index_scores_on_server_id"
  ...
  create_table "treasure_finds", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["server_id"], name: "index_treasure_finds_on_server_id"
    t.index ["treasure_id"], name: "index_treasure_finds_on_treasure_id"
    t.index ["user_id"], name: "index_treasure_finds_on_user_id"
  end
  ...
  create_table "treasures", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["item_id"], name: "index_treasures_on_item_id"
  end
